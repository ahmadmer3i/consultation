...
class _ProviderChatState extends State<ProviderChat> with SingleTickerProviderStateMixin{
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: MyProviderBottomNavigationBar(selectedIndex: 2,),
    );
  }
}